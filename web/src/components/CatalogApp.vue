...
const pageDescription = computed(() => {
  ...
  if (activeCategorySlug.value === 'cat-multi') {
    return 'Один наружный блок и несколько внутренних: удобно, когда на фасаде мало места или нужно охладить несколько комнат.';
  }
  if (activeCategorySlug.value === 'cat-industrial') {
    return 'Кассетные, канальные и напольно-потолочные кондиционеры для офисов, магазинов, залов и помещений со скрытым монтажом.';
  }
