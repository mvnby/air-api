...
STOREFRONT_COLLECTION_OPERATION_IDS = frozenset(
    {
        ...
        operation_ids.SAVE_MANAGER_PRODUCT_COLLECTION_WORKSPACE,
...
SYSTEM_OWNER_OPERATION_IDS = frozenset(
    {
        ...
        operation_ids.GET_PLATFORM_AI_CONNECTION,
        operation_ids.PUT_PLATFORM_AI_CONNECTION,
        operation_ids.DELETE_PLATFORM_AI_CONNECTION,
        operation_ids.GET_PLATFORM_AI_MODELS,
        operation_ids.TEST_PLATFORM_AI_INFERENCE,
...
STOREFRONT_OWNER_OPERATION_IDS = frozenset(
    {
        operation_ids.GET_MANAGER_ORDER_USAGE,
        operation_ids.CREATE_MANAGER_DOCUMENT_LEGAL_ENTITY,
        operation_ids.PATCH_MANAGER_DOCUMENT_LEGAL_ENTITY,
        operation_ids.UPSERT_MANAGER_DOCUMENT_NUMBER_POLICY,
        operation_ids.CREATE_MANAGER_NATIVE_DOCUMENT_TEMPLATE,
        operation_ids.UPLOAD_MANAGER_NATIVE_TEMPLATE_VERSION,
        operation_ids.ACTIVATE_MANAGER_NATIVE_TEMPLATE_VERSION,
        operation_ids.DOWNLOAD_MANAGER_NATIVE_TEMPLATE_VERSION_SOURCE,
        operation_ids.GET_MANAGER_NATIVE_TEMPLATE_GOOGLE_EDIT_SESSION,
        operation_ids.CREATE_MANAGER_NATIVE_TEMPLATE_GOOGLE_EDIT_SESSION,
        operation_ids.SYNC_MANAGER_NATIVE_TEMPLATE_GOOGLE_EDIT_SESSION,
        operation_ids.GET_MANAGER_DOCUMENT_DRIVE_AUTHORIZATION_URL,
        operation_ids.LIST_MANAGER_ANALYTICS_CONNECTIONS,
        operation_ids.UPSERT_MANAGER_YANDEX_METRIKA_CONNECTION,
        operation_ids.UPSERT_MANAGER_YANDEX_DIRECT_CONNECTION,
        operation_ids.UPSERT_MANAGER_YANDEX_WEBMASTER_CONNECTION,
        operation_ids.START_MANAGER_GOOGLE_ANALYTICS_AUTHORIZATION,
        operation_ids.START_MANAGER_GOOGLE_ADS_AUTHORIZATION,
        operation_ids.START_MANAGER_GOOGLE_SEARCH_CONSOLE_AUTHORIZATION,
    }
)
