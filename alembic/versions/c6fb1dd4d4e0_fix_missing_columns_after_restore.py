...
def upgrade() -> None:
    ...
    # Check and add cover_image to article if it doesn't exist
    ...
    # Alter comment column type in order (safe to run multiple times)
    ...
    # Check and add slug to product if it doesn't exist
