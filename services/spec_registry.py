...
REGISTRY_LEGACY_ALIASES_BY_KEY: Mapping[str, tuple[str, ...]] = {
    'airflow_direction': (
        ...
        'Автоматическое управление потоком воздуха (вертикально, горизонтально)',
    ),
    'airflow_max': (
        'Максимальный расход воздуха внутреннего блока',
        'Расход воздуха (высокая скорость), м 3 /ч',
        'Расход воздуха (Низ / Ср / Макс), м³/ч',
        'Расход воздуха Выс./Средн./Низ. , м³',
        'Расход воздуха внутреннего блока',
        'Расход воздуха внутреннего блока м 3 /ч',
        'Максимальный расход воздуха внутреннего блока м 3 /ч',
        'Внутренний блок: Расход воздуха (высокая скорость), м 3 /ч',
        'Внутренний блок: Расход воздуха, м 3 /ч',
        'Расход воздуха, м 3 /ч',
    ),
    ...
    'capacity_heating_kw': (
        ...
        'Теплопроизводительность (кВт) кВт',
        'Нагрев, кВт',
    ),
    'capacity_heating_max_kw': (
        'Нагрев максимум, кВт',
    ...
    'current_cooling_nominal_a': (
        ...
        'Рабочий ток в режиме охлаждения (Ном / Макс), А',
        'Рабочий ток внешнего блока ОХЛАЖДЕНИЕ Ном. (А)',
        'Потребляемый ток в режиме охлаждения А',
    ),
    'current_heating_max_a': (
    ...
    'current_heating_nominal_a': (
        ...
        'Рабочий ток в режиме нагрева (Ном/Макс), А',
        'Рабочий ток  внешнего блока НАГРЕВ Ном. (А)',
        'Потребляемый ток в режиме нагрева А',
    ),
    'dehumidification': (
        'Осушение воздуха',
    ...
    'dimensions_indoor_package_mm': (
        ...
        'Габаритные размеры внутреннего блока в упаковке (ШxВxГ) мм',
    ),
    'dimensions_outdoor_package_mm': (
        ...
        'Габаритные размеры наружного блока в упаковке (ШxВxГ) мм',
    ),
    'drain_pipe_diameter': (
        'Диаметр дренажной трубы: мм (дюйм)',
        'Диаметр трубопровода, дренаж, внутренний блок, Нар. Ø / Внутр. Ø, мм',
    ...
    'energy_class': (
        ...
        'Класс сезонной энергоэффективности охл./нагр., SEEP/SCOP',
    ),
    'energy_class_cooling': (
        'Класс энергоэффективности при охлаждении',
    ...
    'noise_indoor': (
        ...
        'Уровень звукового давления (Выс./Ср./Низ.), дБ (А)',
    ...
    'pipe_gas': (
        ...
        'Диаметр трубопровода, газ, внутренний блок, мм ( дюйм)',
        'Диаметр трубопровода, газ, внешний блок, Наружн. Ø, мм ( дюйм)',
        'Диаметр газовой трубы мм',
        'Диаметр газовой трубы дюйм',
    ),
    'pipe_liquid': (
        'Диаметр жидкостной трубы',
        'Диаметр жидкостной линии, мм',
        'Диаметр труб жидкого хладагента, мм',
        'Диаметр трубопровода, жидкость, внутренний блок, мм ( дюйм)',
        'Диаметр трубопровода, жидкость, внешний блок, Наружн. Ø, мм ( дюйм)',
        'Диаметр жидкостной трубы мм',
        'Диаметр жидкостной трубы дюйм',
    ),
    'pipe_max_height': (
        'Перепад высот',
        'Перепад высот, м',
        'Максимальный перепад высот',
        'Перепад высоты между блоками (Макс), м',
        'Максимальный перепад высот (НБ ~ ВБ), м',
        'Максимальный перепад по высоте между внутренним и наружным блоками м',
    ...
    'pipe_max_length': (
        ...
        'Длина трассы (Мин / Макс), м',
        'Максимальная длина трубопроводов внешнего блока, м',
    ...
    'power_cons_cooling_kw': (
        ...
        'Потребляемая мощность всей системы ОХЛАЖДЕНИЕ (Ном.) кВт',
    ...
    'power_cons_heating_kw': (
        ...
        'Потребляемая мощность в режиме нагрева кВт',
        'Потребление электроэнергии в режиме нагрева (Мин / Ном / Макс), кВт',
        'Потребляемая мощность всей системы НАГРЕВ (Ном.) кВт',
    ...
    'power_supply_outdoor': (
        ...
        'Электропитание внешнего блока (В / Ø / Гц)',
    ),
    'power_supply_voltage': (
    ...
    'refrigerant_additional_g_m': (
        ...
        'Дополнительная заправка хладагента',
        'Дозаправка хладагента (сверх номинальной длины трассы) г/м',
    ),
    'refrigerant_charge_g': (
        'Заводская заправка хладагента',
    ...
    'remote_control': (
        ...
        'Беспроводной ИК пульт управления',
        'Беспроводной ИК пульт',
        'Модель беспроводного ИК пульта',
        'Проводной пульт',
        'Модель проводного пульта',
        'Внутренний блок: Пульт управления',
    ),
    'scop': (
        'SCOP',
        'scop',
        'Коэффициент энергоэффективности SCOP (усредненный) Вт/Вт',
        'Коэффициент энергоэффективности SCOP (теплый) Вт/Вт',
        'Коэффициент сезонной энергоэффективности НАГРЕВ, SCOP',
        'Коэффициент сезонной энергоэффективности НАГРЕВ, SEEP/SCOP',
    ),
    'seer': (
        'SEER (коэффициент/класс)',
        'Коэффициент сезонной энергоэффективности SEER Вт/Вт',
        'Коэффициент сезонной энергоэффективности ОХЛАЖДЕНИЕ, SEEP',
        'Коэффициент сезонной энергоэффективности ОХЛАЖДЕНИЕ, SEEP/SCOP',
    ),
    'self_cleaning': (
        'Самоочистка',
    ...
    'temp_range_cool': (
        ...
        'Рабочий диапазон температур при охлаждении, °C',
        'Рабочие температурные границы наружного воздуха (охлаждение) °C',
    ...
    'temp_range_heat': (
        ...
        'Рабочий диапазон температур при обогреве, °C',
        'Рабочие температурные границы наружного воздуха (нагрев) °C',
    ...
    'uv_sterilization': (
        ...
        'Очистка воздуха UVnano',
    ),
    'voice_control': (
        'Голосовое управление',
        'Управление голосом при помощи smart устройства АЛИСА',
    ),
    'warranty_months': (
        'Гарантия',
        'Срок гарантии мес.',
...
REGISTRY_DIMENSIONS_MAP: dict[str, tuple[str, str, str]] = {
    ...
    "Габаритные размеры наружного блока (ШxВxГ) мм": ("width_outdoor", "height_outdoor", "depth_outdoor"),
    ...
    "Внутренний блок (Ш х В х Г) мм": ("width_indoor", "height_indoor", "depth_indoor"),
    "Внешний блок (Ш х В х Г) мм": ("width_outdoor", "height_outdoor", "depth_outdoor"),
...
def normalize_registered_value(
    ...
    *,
    ...
    if key in {"pipe_max_length", "pipe_max_height", "multi_max_total_pipe_length"} and len(numbers) > 1:
        selected = max(numbers)
