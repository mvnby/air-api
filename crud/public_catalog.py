...
class PublicCatalogDAO:
    """Read active offers without ever falling back to shared Product prices."""
    ...
    @staticmethod
    def _select_products(tenant_scope: TenantScope, *, load_image_variants: bool = False):
        return (
    ...
    async def count_filtered(
        ...
        *,
        ...
        stmt = (
            ...
            .select_from(Product)
            .join(TenantOffer, TenantOffer.product_id == Product.id)
            .where(*PublicCatalogDAO._visible_offer_conditions(tenant_scope))
        )
        stmt = ProductDAO._apply_common_filters(
            session,
            stmt,
    ...
    async def get_filter_stats(
        ...
        *,
        ...
        offer_conditions = PublicCatalogDAO._visible_offer_conditions(tenant_scope)
        price_area = (
