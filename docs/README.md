...
| Платформенное AI-подключение ZAPRO.SU | [Ключ, доступ и проверка моделей](platform-ai-zaprosu.md) |
...
| Монтаж и новая сетка цен | [Памятка для менеджера](installation-grid-manager-guide.md), [статус выпуска 25 сентября](installation-grid-release-2026-09-25.md), [технический контракт #955](installation-estimate-contract.md), [процедура применения](installation-grid-rollout.md) |
...
- [Исправление фильтра формы блока](catalog-indoor-filter-repair.md) — проверенный
  срез и порядок адресного обновления служебных характеристик.
- [Сверка с прайсом MDV](catalog-mdv-price-audit.md) — подтверждённые ошибки
  формы блока и Wi-Fi, границы обновления и план для производства.
- [Единый источник Wi-Fi](catalog-wifi-source-of-truth.md) — подтверждённые
  статусы MDV, вывод старых продуктовых тегов и порядок применения.
