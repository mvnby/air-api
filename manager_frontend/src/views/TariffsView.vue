      ...
      <div class="flex items-start gap-3">
        ...
        <div>
          ...
          <div class="mt-0.5 text-xs text-blue-800/80 dark:text-blue-200/80">
            Изменения сначала сохраняются как черновик. После публикации новая книга цен используется для расчётов монтажа на сайте и в Manager; сохранённые сметы не меняются.
          </div>
        </div>
      </div>
