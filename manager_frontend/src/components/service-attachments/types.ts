export const SERVICE_ATTACHMENT_CATEGORIES = [
  ...
  { value: 'installation_indoor', label: 'Место внутреннего блока' },
  { value: 'installation_outdoor', label: 'Место наружного блока' },
  { value: 'installation_route', label: 'Трасса' },
  { value: 'installation_facade', label: 'Фасад' },
  { value: 'installation_power', label: 'Электропитание' },
