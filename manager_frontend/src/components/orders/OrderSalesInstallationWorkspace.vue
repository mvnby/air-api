...
const toneClasses = {
  ...
  teal: 'border-brand-200 bg-brand-50 text-brand-900 dark:border-brand-500/30 dark:bg-brand-500/10 dark:text-brand-200',
  ...
  <section class="mt-3">
    ...
    <div class="grid gap-2 sm:grid-cols-2">
      <button
        ...
        :class="[toneClasses[lane.tone], activeTarget === lane.target ? 'ring-2 ring-brand-500/60 ring-offset-1 dark:ring-offset-slate-950' : '']"
