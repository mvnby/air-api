  ...
  <section class="rounded-2xl border border-slate-200 bg-slate-50/70 p-4 dark:border-slate-800 dark:bg-slate-950/40">
    ...
    >
      <div class="min-w-0">
        <h4 class="flex items-center gap-2 text-sm font-bold text-slate-900 dark:text-white">
          <span class="material-icons-round text-[18px] text-brand-600">outgoing_mail</span>
          Письма
    ...
    <div v-if="expanded" class="mt-3">
      <div class="flex gap-2">
        ...
        <button type="button" class="inline-flex items-center gap-1 rounded-lg border border-brand-200 bg-white px-2.5 py-1.5 text-xs font-semibold text-brand-700 hover:bg-brand-50 dark:border-brand-500/30 dark:bg-slate-900 dark:text-brand-300 dark:hover:bg-brand-500/10" @click="openOutbox">
      ...
      <div v-else class="mt-3 space-y-2">
        <article
          ...
          :key="email.id"
          class="cursor-pointer rounded-xl border border-slate-200 bg-white px-3 py-2 transition hover:border-brand-200 hover:bg-brand-50/40 dark:border-slate-800 dark:bg-slate-900 dark:hover:border-brand-500/30 dark:hover:bg-brand-500/10"
