...
import type { ManagerOrderTransferProposal_Input } from './ManagerOrderTransferProposal_Input';
...
export type ManagerOrderTransferOrder_Input = {
    ...
    proposals?: Array<ManagerOrderTransferProposal_Input>;
